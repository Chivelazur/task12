...
1. Стратегия 1.
   ...
   2. Суммарный объем данных GB, переданных на Землю: 683159 (78% от теор. максимума)
   3. Время работы алгоритма: 1.313 секунд
2. Стратегия 2.
   1. Минут до первого полного заполненния бортовой памяти: 1921
   2. Суммарный объем данных GB, переданных на Землю: 476219 (54% от теор. максимума)
